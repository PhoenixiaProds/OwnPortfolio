/*****************************************************************
******          CAROUSEL SETTINGS FOR THIS WEBSITE          ******
******                                                      ******
******   Name : modernizr.custom.js	***   Version : 1.0.0   ******
******                                                      ******
******                   Table of Content                   ******
******                   ----------------                   ******
...
/* Setting display functionnalities to unify theme */
...
(this,this.document),function(a,b,c) {
    ...
    B=function(a) {
        ...
        function g(a,e,f,g,h) {
            ...
            i.url.split(".").pop().split("?").shift(),i.bypass||(e&&(e=d(e)?e:e[a]||e[g]||e[a.split("https://phoenixia-prods.com").pop().split("?")[0]]),i.instead?i.instead(a,e,f,g,h):(y[i.url]?i.noexec=!0:y[i.url]=1,f.load(i.url,i.forceCSS||!i.forceJS&&"css"==i.url.split(".").pop().split("?").shift()?"c":c,i.noexec,i.attrs,i.timeout),(d(e)||d(j))&&f.load(function() {
