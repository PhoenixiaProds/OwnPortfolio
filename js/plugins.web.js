...
******                   Table of Content                   ******
******                   ----------------                   ******
******  - Carousel      Plugin Owl Carousel v2.0.0          ******
******  - Charts        Plugin Easy Pie Chart v1.7.0        ******
*****************************************************************/
...
(function ($, window, document) {
    var Carousel = {
        init : function (options, el) {
            var base = this;
/* On initializing, get options */
            base.$elem = $(el);
            base.options = $.extend({}, $.fn.owlCarousel.options, base.$elem.data(), options);
            base.userOptions = options;
            base.loadContent();
        },
/* Then, loading content of carousel */
...
/* Catching style and elements classes */
        logIn : function () {
            var base = this;
...
/* On startup, chaining events to make carousel displayed properly */
        onStartup : function () {
            var base = this;
            base.updateItems();
            base.calculateAll();
...
/* Reordering array by screen size */
...
/* Prevneting from number of items being less than declared */
...
/* Calcultating min and max values */
...
/* In case image loading in less than 10 seconds */
...
/* Else, removing height attributes */
                }
            }
        ...
        transitionTypes : function (className) {
            var base = this;
/* Avaible transitions are : "fade", "backSlide", "goDown" and "fadeUp" */
...
/* Applying canvas on retina devices */
	    var scaleBy = 1;
...
/* Moving 0,0 coordinates to the center */
	    ctx.translate(options.size / 2, options.size / 2);
/* rotating canvas -90 degrees */
...
/* Drawing a circle around the center of the canvas */
...
/* Drawing the scale of the chart */
...
/* Requesting animation frame wrapper with polyfill */
	    var reqAnimationFrame = (function() {
		    return  window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(callback) {
				window.setTimeout(callback, 1000 / 60);
			};
	    }());
/* Drawing the background including scale and track */
...
/* Executing barcolor if it is a function and make % turn into a value */
            var color;
...
/* Animating from some percent to some other percentage */
    ...
    var EasyPieChart = function(el, opts) {
	    var defaultOptions = {
            barColor: '#767676',trackColor: '#3b3b3b', lineCap: 'round', lineWidth: 6, size: 154, rotate: 0, animate: {
...
/* Detecting present renderer */
        ...
        var options = {};
        var currentValue = 0;
/* Initializing elements by creating options object and rendering */
        var init = function() {
            this.el = el;
            this.options = options;
/* Merging user options as default */
...
/* Calling at easing jQuery functions */
...
/* Processing to previous animate options to avoid breaks */
...
/* Creating renderer, initializing draw and update */
